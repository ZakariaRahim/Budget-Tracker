 <?php
    ...
    if(isset($_POST['add'])){
        ...
        if(Budget::updateRevenue($id, $decription, $cost, $author))
    ...
    <div class="container">
        ...
        <p class="revenue-title">Update Revenue</p>
            <form action="updateRevenue.php" method="post">
